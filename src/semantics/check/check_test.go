...
var error_tests = []one{
	...
	{"модуль x; фн Ф(ц: Цел) {}; вход { Ф() }", "СЕМ-ЧИСЛО-АРГУМЕНТОВ"},
	{"модуль x; фн Ф(ц1: Цел, ц2: Цел) {}; вход { Ф(1) }", "СЕМ-ЧИСЛО-АРГУМЕНТОВ"},
	{"модуль x; фн Ф(ц: Цел) {}; вход { Ф(ложь) }", "СЕМ-НЕСОВМЕСТИМЫй-АРГУМЕНТ"},
	{"модуль x; фн Ф(л: Лог) {}; вход { Ф(1) }", "СЕМ-НЕСОВМЕСТИМЫй-АРГУМЕНТ"},
}
