...
var error_tests = []one{
	...
	{"модуль x; вход { выбор 1.0 {} }", "СЕМ-КОГДА-ОШ-ТИП"},
	{"модуль x; вход { выбор 1 { когда 1.0:} }", "СЕМ-КОГДА-ОШ-ТИПЫ"},
	{"модуль x; вход { выбор { когда 1:} }", "СЕМ-КОГДА-ОШ-ПРЕДИКАТ"},
	{"модуль x; вход { выбор { когда \"фф\":} }", "СЕМ-КОГДА-ОШ-ПРЕДИКАТ"},
	...
	{"модуль x; осторожно; вход { пусть б = \"фи\"(:осторожно Строка8); б[0] := 1 }", "СЕМ-НЕ-ПРИСВОИТЬ"},
