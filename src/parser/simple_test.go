...
var valid_texts = []string{
	...
	"модуль м; вход { когда 1 {} }",
	"модуль м; вход { когда 1 { есть 1: } }",
	"модуль м; вход { когда 1 { есть 1: а := 1} }",
	"модуль м; вход { когда 1 { есть 1: есть 2,3: } }",
	"модуль м; вход { когда 1 { есть 1: есть 2,3: а := 2} }",
	"модуль м; вход { когда 1 { есть 1: есть 2,3: иначе} }",
	"модуль м; вход { когда 1 {иначе} }",
	"модуль м; вход { когда 1 {иначе а := 5} }",
}
